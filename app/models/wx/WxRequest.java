...
public class WxRequest {
	...
	public String getTim_Str() {
		return tim_Str;
	}

	public void setTim_Str(String tim_Str) {
		this.tim_Str = tim_Str;
	}

	public static void setAppid(String appid) {
		WxRequest.appid = appid;
	}

	public static void setMch_id(String mch_id) {
		WxRequest.mch_id = mch_id;
	}

	public static void setDevice_info(String device_info) {
		WxRequest.device_info = device_info;
	}

	public static void setFee_type(String fee_type) {
		WxRequest.fee_type = fee_type;
	}
